...
type MACSettings struct {
	...
	NetworkInitiatedDownlinkInterval *time.Duration `protobuf:"bytes,31,opt,name=network_initiated_downlink_interval,json=networkInitiatedDownlinkInterval,proto3,stdduration" json:"network_initiated_downlink_interval,omitempty"`
	XXX_NoUnkeyedLiteral             struct{}       `json:"-"`
	XXX_sizecache                    int32          `json:"-"`
}
...
func (m *MACSettings) GetNetworkInitiatedDownlinkInterval() *time.Duration {
	if m != nil {
		return m.NetworkInitiatedDownlinkInterval
	}
	return nil
}
...
var fileDescriptor_a656ee0551c94a80 = []byte{
	...
	0x04, 0xc9, 0x22, 0x68, 0x42, 0x96, 0xb3, 0x96, 0xe3, 0xd5, 0x02, 0x7c, 0xac, 0x48, 0x3d, 0x4c,
	0x8f, 0x28, 0xd9, 0x96, 0x2c, 0xcd, 0x0e, 0x67, 0x9a, 0xd4, 0x98, 0xc0, 0xcc, 0x6c, 0x4f, 0x83,
	0x22, 0x6d, 0xab, 0xca, 0xb5, 0xc9, 0x66, 0x2b, 0x5b, 0x49, 0x6a, 0x4b, 0xa7, 0xad, 0xbd, 0xac,
	0x8f, 0x39, 0xa5, 0x2a, 0x97, 0xd4, 0xde, 0x76, 0x73, 0x48, 0x95, 0x2b, 0x55, 0x5b, 0xe5, 0x63,
	...
	0xa3, 0x20, 0xa8, 0x66, 0x68, 0x54, 0xf3, 0x28, 0x0a, 0x3f, 0x4b, 0xc2, 0xc0, 0x3d, 0xec, 0xba,
	0xa6, 0x6d, 0xa1, 0x87, 0x90, 0x32, 0xf0, 0x9e, 0xaa, 0x19, 0x06, 0x91, 0x13, 0xb3, 0x52, 0x31,
	0x53, 0xbd, 0xf1, 0xe5, 0xd7, 0x33, 0x3d, 0xff, 0xf1, 0xf5, 0xcc, 0x9f, 0xed, 0xd8, 0x25, 0xfa,
	...
	0xe7, 0x52, 0x22, 0x2f, 0xb1, 0xc5, 0xbf, 0xfa, 0x7a, 0x46, 0x52, 0x38, 0x2b, 0x3a, 0x0b, 0x43,
	...
	0x7d, 0x85, 0xab, 0xa6, 0xd8, 0x6b, 0xfe, 0xe2, 0x3f, 0x67, 0x24, 0x25, 0x2d, 0xf8, 0x2a, 0x14,
	0x61, 0x38, 0xfd, 0xe3, 0x06, 0x6e, 0x30, 0x0c, 0xc7, 0xa9, 0x99, 0x3a, 0x57, 0x7e, 0xbe, 0x6e,
	0xcd, 0xb4, 0x76, 0x5d, 0x39, 0x3d, 0xdb, 0x5b, 0x1c, 0x2c, 0x9f, 0x6b, 0x3d, 0xc6, 0x4a, 0x48,
	0xbc, 0x2c, 0x68, 0x95, 0x49, 0x0f, 0xa8, 0xcd, 0x94, 0x7b, 0x3d, 0xf9, 0x9b, 0x2f, 0x66, 0xa4,
	...
	0x9a, 0x3a, 0xac, 0xf6, 0xfd, 0x84, 0xa9, 0x80, 0x92, 0xd7, 0x0c, 0xd2, 0x34, 0x87, 0xde, 0x00,
	...
	0x19, 0xb8, 0xa6, 0x1d, 0x70, 0x59, 0x37, 0xd1, 0x2d, 0xb3, 0x61, 0xf4, 0x7d, 0x48, 0x93, 0xfd,
	0x45, 0x41, 0x93, 0xe6, 0xaf, 0x3f, 0xd1, 0xfa, 0xfa, 0xca, 0x3e, 0xa7, 0x8d, 0xbc, 0x78, 0x8a,
	0xec, 0x2f, 0x7a, 0xfc, 0x1f, 0xc2, 0x28, 0xe7, 0x0f, 0x0e, 0xd2, 0xde, 0xde, 0x76, 0x31, 0x95,
	0x81, 0x43, 0x4d, 0x77, 0x3a, 0xc9, 0x77, 0x39, 0x55, 0x04, 0x71, 0x98, 0x21, 0x36, 0x4d, 0x32,
	0x19, 0x91, 0xfd, 0x72, 0x4c, 0x46, 0x83, 0x27, 0x94, 0x11, 0xd9, 0x2f, 0x37, 0xcb, 0xa8, 0x04,
	0x43, 0x0c, 0x77, 0x9b, 0xe0, 0x1f, 0x37, 0xb0, 0xa5, 0x1f, 0xc8, 0x99, 0x59, 0xa9, 0x98, 0xac,
	0xa6, 0x0f, 0xab, 0xfd, 0xe5, 0x64, 0xf1, 0x8b, 0xbf, 0xed, 0x57, 0x32, 0x64, 0xbf, 0xbc, 0xea,
	...
	0x18, 0x69, 0x64, 0x23, 0x99, 0xba, 0xb6, 0x1f, 0x8c, 0x23, 0x03, 0x26, 0x08, 0xfe, 0xd8, 0x36,
	...
	0xdb, 0x30, 0xe2, 0x98, 0xd6, 0x8e, 0xea, 0xd6, 0x6c, 0x1a, 0x39, 0xd9, 0x3c, 0x3f, 0xd9, 0xc1,
	...
	0xcd, 0xd2, 0x7e, 0x13, 0xf2, 0x5b, 0x58, 0xd3, 0x6d, 0x2b, 0xb2, 0x2d, 0x14, 0xdf, 0x56, 0xce,
	...
	0x4d, 0x92, 0xda, 0x68, 0x92, 0x47, 0x14, 0x6a, 0xd2, 0xf7, 0x00, 0x05, 0x52, 0x0b, 0x39, 0x13,
	...
	,
}
...
func (this *MACSettings) Equal(that interface{}) bool {
	...
	if this.NetworkInitiatedDownlinkInterval != nil && that1.NetworkInitiatedDownlinkInterval != nil {
		if *this.NetworkInitiatedDownlinkInterval != *that1.NetworkInitiatedDownlinkInterval {
			return false
		}
	} else if this.NetworkInitiatedDownlinkInterval != nil {
		return false
	} else if that1.NetworkInitiatedDownlinkInterval != nil {
		return false
	}
	return true
}
...
func (this *MACSettings) String() string {
	...
	s := strings.Join([]string{`&MACSettings{`,
		...
		`NetworkInitiatedDownlinkInterval:` + strings.Replace(fmt.Sprintf("%v", this.NetworkInitiatedDownlinkInterval), "Duration", "types.Duration", 1) + `,`,
		`}`,
	}, "")
	return s
}
